...
DATA_DIR="data/bionlp2004spanner"
PRETRAINED="bert-large-uncased"
BERT_DIR="bert-large-uncased" # "/workspace/SpanNER/Projects/"${PRETRAINED}




dataname=bionlp2004
n_class=6  # O, DNA, protein, cell_type, cell_line, RNA
BERT_DROPOUT=0.2
MODEL_DROPOUT=0.2
LR=1e-5
MAXLEN=128
...
OUTPUT_DIR="/workspace/SpanNER/train_logs/$dataname/${modelName}"
mkdir -p $OUTPUT_DIR
